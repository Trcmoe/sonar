...
@NoArgsConstructor
@AllArgsConstructor
public final class RegistryDataPacket implements SonarPacket {
  ...
  public static SonarPacket @NotNull [] of(final @NotNull CompoundBinaryTag rootTag) {
    final SonarPacket[] packets = new SonarPacket[rootTag.size()];
    int index = 0;
